...
class Achievements {
	public static var achievementsStuff:Array<Dynamic> = [ //Name, Description, Achievement save tag, Hidden achievement
		["Gamejolt",	"Log in to GameJolt.",						'gamejolt_log_in',	 true],
		["Banned",	"Complete the aflac week on hard",						'aflac_hard',	 false],
		["Rematch!",	"Complete the Rematch week on hard",						'rematch_hard',	 false],
		["Dave",	"Complete the Dave week on hard",						'dave_hard',	 false],
		["Not today, thank you!",	"Dodge all attacks in the end",						'dodge_all',	 false],
		["Easter Eggs!",	"Find all 15 easter eggs",						'all_easter_eggs',	 false],
		["The Ultimate Showdown",	"Play & beat Copycat",						'copycat_beat',	 false]
	];
